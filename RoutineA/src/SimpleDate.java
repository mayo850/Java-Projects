...
public class SimpleDate {
	...
	/**
	 * constructs a SimpleDate object wiht the given month, day, and year
	...
	public SimpleDate(int month, int day, int year) {
		...
		if (day < MIN_DAY
				|| (isLeapYear(year)
						&& (month == FEB && day > LEAP_DAY || month != FEB && day > DAYS_IN_MONTH[month - 1]))
				|| (!isLeapYear(year) && day > DAYS_IN_MONTH[month - 1])) {
