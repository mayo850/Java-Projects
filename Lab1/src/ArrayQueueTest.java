...
public class ArrayQueueTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			QueueADT queue3 = new ArrayQueue<String>(-2);
			System.out.println("...failed");
		...
		try {
			...
			if (queue.size() == 3 && queue.toString().equals("[6, 20, 13]")) {
				...
				System.out.println("add, size, or toString failed");
		...
		try {
			...
			if (one == 6 && two == 20 && queue.size() == 1 && queue.toString().equals("[13]")) {
				...
				System.out.println("remove, size, or toString failed");
		...
		try {
			...
			if (queue.toString().equals("[14, 5, 16, 7]")) {
				...
				System.out.println("add or toString failed");
		...
		try {
			...
			queue.add(19);
			queue.add(25);;
			System.out.println("After 19, 25 added.");
			if (queue.toString().equals("[14, 5, 16, 7, 19, 25]")) {
				System.out.println("...passed");
			} else {
				System.out.println("add or toString failed");
				System.out.println("    correct queue: [14, 5, 16, 7, 19, 25]");
				System.out.println("    your queue: " + queue);
				System.exit(1);
			}
		} catch (Exception e) {
		...
		try {
			...
			if (first == 14 & queue.size() == 6 && queue.toString().equals("[14, 5, 16, 7, 19, 25]")) {
				System.out.println("\nPeek was correct.");
			} else {
				System.out.println("\nPeek failed.");
				System.out.println("    correct peek element: 14");
		...
		try {
			...
			if (queue.size() == 0 && queue.toString().equals("[]")) {
				...
				System.out.println("    size of your queue: " + size);
				System.out.println("    correct queue: []");
				System.out.println("    your queue: " + queue);
				System.exit(1);
			}
