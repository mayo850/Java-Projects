...
public class ArrayIntList {
	...
	int index= 0;
	  ...
	  int [] tempArray = new int[numTimes + size];
	...
	public ArrayIntList cumulativeSum(){
		 ...
		 ArrayIntList n = new ArrayIntList();
		  ...
		  n.size = size;
		for(int i = 1; i<size; i++) {
			n.elementData[i] = n.elementData[i-1]+elementData[i];
	...
	public void removeFrontN(int number) {
		...
		int tempArray[] = new int [size - number];
