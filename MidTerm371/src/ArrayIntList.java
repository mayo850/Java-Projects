...
public class ArrayIntList {
	 ...
	 * 
	 * @param index - the position where the value is added
	 * @param value - the integer to be added to this list at the given index
	 ...
	 * 
	 * @param index - the position of the element returned
	 ...
	 * 
	 * @param index - the position of the element returned
	 * @param value - the integer to replace this list's element at the given
	 *              position
	 * @throws IndexOutOfBoundsException for invalid index
	 */
	 ...
	 * 
	 * @param value - the integer to search for in the list
	 * @return the position of the first occurrence of the given value (-1 if not
	 *         found)
	 */
	 ...
	 * 
	 * @param index - the position of the element to remove from this list
	 * @throws IndexOutOfBoundsException for invalid index
	 */
	...
	/**
	 * increases the capacity to insure that it can hold at least the number of
	 * elements specified by the minimum capacity arguement.
	 * 
	...
	public ArrayIntList cumulativeSum() {
		...
		list.elementData[list.size] = elementData[0];
		
		list.size = size;
		
		for(int i = 1 ; i < list.size; i++) {
			list.elementData[i] = list.elementData[i-1] + elementData[i];
		}
	...
	public void removeFrontN(int number) {
	...
	public void insert(int num , int index, int numTimes) {
		size = size + numTimes;
